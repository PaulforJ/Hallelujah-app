...
export default function App() {
  ...
  useEffect(()=>{
    if(!auth) return;
    setFeedLoading(true);
    Promise.all([sb.getPosts(), sb.getMyLikes(auth.token, auth.user.id)])
