...
function BottomNav({tab, setTab}) {
  ...
  return (
    <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:480,background:`${C.bg}F2`,backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",borderTop:`1px solid ${C.border}`,display:"flex",alignItems:"center",padding:"8px 0 20px",zIndex:50}}>
...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,color:C.cream,maxWidth:480,margin:"0 auto",position:"relative",fontFamily:"'DM Sans',sans-serif"}}>
      {/* Top bar */}
